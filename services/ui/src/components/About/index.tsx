    ...
    <section id="about">
      ...
      <div className="container about__container">
        ...
        <div className="about__content">
          ...
          <p>
            ⛏ Currently leading the development and production launch of a
            Renewable Energy Community management platform. <br /> 👨‍🔧 A
            multi-role and flexible person extensively involved in web3
